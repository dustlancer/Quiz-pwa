...
function LoginCard(parent) {
    this.parent = parent;

    this.handleSubmit = (username, psw) => {
        if (username === '') {
    ...
    this.render = () => {
        ...
        glass_card.className = 'glassy mx-3 min-h-[70%] flex flex-col items-center justify-center border-b-1 border-white px-5 w-[95%]';
        ...
        username_input.className = 'bg-indigo-200 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5';
        ...
        psw_input.className = 'bg-indigo-200 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5';
